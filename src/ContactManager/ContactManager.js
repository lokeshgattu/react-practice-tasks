...
class ContactManager extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    if (this.state.isUpdated) {
      axios
        .put(`http://localhost:3001/ContactsDetails/${this.state.isId}`, {
        ...
        .catch((err) =>
          this.setState({ statusMsg: "some error occurred please try again" })
        );
      this.setState({ isUpdated: !this.state.isUpdated });
    } else {
      axios
        .post("http://localhost:3001/ContactsDetails", {
          cname: this.state.ipName,
          cemail: this.state.ipEmail,
          cno: this.state.ipNumber,
        })
  ...
  handleDelete = (e, keyid) => {
    axios
      .delete(`http://localhost:3001/ContactsDetails/${keyid}`)
      .then((res) => {
          ...
          <div className="contact">
            <div class="from-container">
              ...
              <button className="button" onClick={(e) => this.handleSubmit(e)}>
                {this.state.isUpdated ? "Update Contact" : "Create Contact"}
              </button>
            ...
            <div className="img-container">
              ...
              <img
                src="https://th.bing.com/th/id/OIP.iBAwoYimuaiMwMfH8WTQfgHaFC?w=235&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7"
                alt="No Image"
              />
            </div>
          </div>
          ...
          {this.state.contacts.map((item) => (
            <div className="details" key={item.id}>
              ...
              <button
                ...
                onClick={(e) => this.handleUpdate(e, item.id)}
              >
                Update
              </button>
              <br></br>
